...
USO:
  * ABRA O MONITOR SERIAL E USE OS COMANDOS:
    ...
    h : Carrega novamente a lista de comandos
    
LIGAÇÕES DO MÓDULO AO NODEMCU / WEMOS D1:
  GND: CONECTAR AO GND DO NODEMCU / WEMOS D1
  VCC: CONECTAR AO PINO DE SAÍDA DE 3V3
  SIG: CONECTAR AO PINO D1 DO NODEMCU / WEMOS D1
  CH: CONECTAR AO PINO D2 DO NODEMCU / WEMOS D1
...
unsigned long last_tempo = 0;//Armazena o momento da última solicitação automática de feedback, a função time() reinicia em 50 dias com o NODEMCU / WEMOS D1 constantemente ligado
...
void setup(){
  ...
  Serial.begin(115200);//Inicializa a comunicação serial em 115200
  ...
  Serial.println("h : Carrega novamente a lista de comandos");
}
	...
	if(canal){//Se estiver em 1 é o canal 2
      ...
      switch(comando){//Verifica qual é o comando, só executa comandos válidos
        ...
        break;
		    ...
		    case 13:  //byte enviado pelo monitor serial após os caracteres digitados
          //Não faz nada, é o byte enviado pelo monitor serial após os caracteres digitados
        break;
    }
  }
