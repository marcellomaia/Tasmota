...
LIGAÇÕES DO MÓDULO AO ESP32:
  GND: CONECTAR AO GND DO ESP32
  VCC: CONECTAR AO PINO DE SAÍDA DE 3V3
  SIG: CONECTAR AO PINO 23 DO ESP32
  CH: CONECTAR AO PINO 22 DO ESP32
...
//Cria um novo objeto
DM02A dimmer(23, 22);//SIG, CH, EN - Se não usar o EN, deixar sem informar
...
unsigned long last_tempo = 0;//Armazena o momento da última solicitação automática de feedback, a função time() reinicia em 50 dias com o ESP32 constantemente ligado
